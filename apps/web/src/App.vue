  ...
  <div class="min-h-screen bg-base-200">
    ...
    <div class="navbar bg-base-100 border-b border-base-300 px-6">
      <div class="navbar-start">
        <span class="text-xl font-bold">composer-ai</span>
      </div>
      <div class="navbar-end gap-4">
        <a href="/design-system" class="link link-hover text-sm">Design System</a>
    ...
    <div class="hero py-24">
      <div class="hero-content text-center flex-col gap-6">
        ...
        <h1 class="text-5xl font-extrabold tracking-tight">Your stack is ready.</h1>
